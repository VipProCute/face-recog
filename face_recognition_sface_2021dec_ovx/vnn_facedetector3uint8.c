...
vsi_nn_graph_t * vnn_CreateFacedetector3Uint8
    (
...
/*-----------------------------------------
 ...
 -----------------------------------------*/
    ...
    /* @attach_Concat_/Concat/out0_0:out0 */
    memset( &attr, 0, sizeof( attr ) );
    attr.size[0] = 4;
    attr.size[1] = 16800;
    attr.size[2] = 1;
    attr.dim_num = 3;
    attr.dtype.scale = 0.04298603907227516;
    attr.dtype.zero_point = 121;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    NEW_NORM_TENSOR(norm_tensor[0], attr, VSI_NN_TYPE_UINT8);

    /* @attach_Softmax_/Softmax/out0_1:out0 */
    memset( &attr, 0, sizeof( attr ) );
    attr.size[0] = 2;
    attr.size[1] = 16800;
    attr.size[2] = 1;
    ...
    /* @attach_Concat_/Concat_2/out0_2:out0 */
    memset( &attr, 0, sizeof( attr ) );
    attr.size[0] = 10;
    attr.size[1] = 16800;
    attr.size[2] = 1;
    attr.dim_num = 3;
    attr.dtype.scale = 0.0782560259103775;
    ...
    attr.size[3] = 1;
    attr.dim_num = 4;
    attr.dtype.scale = 1.074509859085083;
...
error:
    ...
    vnn_ReleaseFacedetector3Uint8( graph, release_ctx );

    return NULL;
} /* vsi_nn_CreateFacedetector3Uint8() */

void vnn_ReleaseFacedetector3Uint8
    (
    vsi_nn_graph_t * graph,
    vsi_bool release_ctx
    )
...
} /* vsi_nn_ReleaseFacedetector3Uint8() */
